...
<object type="application/x-shockwave-flash" data="'+source+'player_mp3.swf" width="200" height="20">'
							+'	<param name="movie" value="'+source+'player_mp3.swf" />'
							+'	<param name="bgcolor" value="#ffffff" />'
							+'	<param name="FlashVars" value="mp3='+escape(val)+'&amp;autoplay=0" />'
							+'</object>
                            
                            
22/May/2012
*/
//var source = "/cakeflybook/app/webroot/js/"; 
(function(){CKEDITOR.dialog.add('mp3player',
	...
	onOk:function(){
					...
					var text='<a href="'+val+'" title="Play sound" class="sm2_button">Play Link</a>';
