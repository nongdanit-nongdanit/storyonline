...
CKEDITOR.dialog.add('jwplayer', function (editor) {
		...
		function ReturnPlayer() {
			var fileUrl = CKEDITOR.dialog.getCurrent().getContentElement('info', 'video_url').getValue();
                        tempFileUrl = CKEDITOR.dialog.getCurrent().getContentElement('info', 'video_url').getValue();
		  var previewUrl = CKEDITOR.dialog.getCurrent().getContentElement('info', 'preview_url').getValue();
                        tempImageUrl = CKEDITOR.dialog.getCurrent().getContentElement('info', 'preview_url').getValue();
...
//			JWEmbem += " width='" + width + "' height='" + height + "'" + " src='" + JWplayer + "' allowscriptaccess='always'" + " allowfullscreen='true' flashvars='file=" + fileUrl + preview + skin + "&autostart=" + auto + "'/>" + "</object>";
                     ...
                     JWEmbem = "";
                        ...
                        JWEmbem += '<div id="'+randId+'">Loading the player...</div>';
                        JWEmbem += '<script type="text/javascript">';
                        JWEmbem += 'jwplayer("'+randId+'").setup({';
                        JWEmbem += 'file: "'+fileUrl+'",';
                        JWEmbem += 'image: "'+previewUrl+'",';
                        JWEmbem += '});';
                        JWEmbem += '</script>';
...
//                            var tmpJWEmbem = "";
//                            var randId = randomString();
//                            tmpJWEmbem += '<div id="'+randId+'">Loading the player...</div>';
//                            tmpJWEmbem += '<script type="text/javascript">';
//                            tmpJWEmbem += 'jwplayer("'+randId+'").setup({';
//                            tmpJWEmbem += 'file: "'+tempFileUrl+'",';
//                            tmpJWEmbem += 'image: "'+tempImageUrl+'",';
//                            tmpJWEmbem += '});';
//                            tmpJWEmbem += '</script>';
