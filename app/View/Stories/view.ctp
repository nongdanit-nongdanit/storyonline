			...
			<div class="row">
				...
				<div class="col-sm-12 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center"><?php echo $data['slug']?></h2>
                        <?php 
                            $dataAc = $data['story'];
                            if(!empty($dataAc)):
                        ?>
                        <?php
                            ...
                            $this->paginator->options(array(
                                ...
                                /*
                                //http://www.devdungeon.com/content/ajax-pagination-and-sorting-cakephp-2x
        //https://jpsolution.wordpress.com/tag/creating-simple-ajax-pagination-with-cakephp-2-x/
                                */
                            ?>
                        <div class="col-sm-12 pagination">
                            <?php if($this->paginator->param('count') > 36):?>                            
								...
								<div class="single-products">
                                    ...
                                    <?php $name_img =  $DataComponent->get_image_story($rowAc['Article']['id'].'.jpg',$dir);?>
										<?php 
                                            ...
                                            ?>                                        
                                        <?php 
                                        $a = "<h2 title='".$rowAc['Article']['name']."'>".$DataComponent->subString($DataComponent->showNameArticles($rowAc['Article']['name']),23)."</h2>";
