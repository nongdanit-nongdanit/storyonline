						...
						<div class="col-sm-3">
							<div class="product-image-wrapper">
								<div class="single-products">
                                        ...
                                        <p class="time_update text-center"><?php echo $DataComponent->get_time_text($row['Article']['updated'])?></p>
                                    ...
                                    ?>
                                            ...
                                            <?php if(!empty($current_user)) echo $this->Html->link('Clone',"JavaScript:void(0);",array('class'=>'btn btn-danger cloneindex', 'idx'=>$row['Article']['id'], 'id'=> "clone".$row['Article']['id']))?>
										</div>
								</div>
								<!--<div class="choose">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade <?php echo ($i==1) ? "active in" : "";?> " id="<?php echo $href;?>" >
								...
								<div class="col-sm-3">
                                            ...
                                            ?>
                                                ...
                                                echo $this->Html->link($a, 
                                                    array(
                                                        'controller' => 'stories',
                                                        'action' => 'detail_story',
                                                        'slug' => strtolower(Inflector::slug($DataComponent->showNameArticles($rowArticle['Article']['name']))),
                                    ...
                                    ?><?php if(!empty($current_user)) echo $this->Html->link('Clone',"JavaScript:void(0);",array('class'=>'btn btn-danger cloneindex', 'idx'=>$rowArticle['Article']['id'], 'id'=> "clone".$rowArticle['Article']['id']))?>
											</div>
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
                                ...
                                <?php if(!empty($data['dataStoryNew']['data1'])):?>
                                    ...
                                    ?><?php if(!empty($current_user)) echo $this->Html->link('Clone',"JavaScript:void(0);",array('class'=>'btn btn-danger cloneindex', 'idx'=>$row1['Article']['id'], 'id'=> "clone".$row1['Article']['id']))?>
    												</div>
                                ...
                                <div class="item">
                                 ...
                                 ?>
                                    ...
                                    ?>
                                    <?php if(!empty($current_user)) echo $this->Html->link('Clone',"JavaScript:void(0);",array('class'=>'btn btn-danger cloneindex', 'idx'=>$row2['Article']['id'], 'id'=> "clone".$row2['Article']['id']))?>
												</div>
											</div>
										</div>
									</div>
